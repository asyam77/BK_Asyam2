                ...
                <div class="border-black/12.5 shadow-soft-xl relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                  ...
                  <form action="{{ route('admin-storePoli') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <div class="mb-4 flex justify-center">
                        <button type="submit" class="btn btn-success shadow-soft-2xl rounded-lg bg-dark stroke-0 text-center xl:p-2.5" style="background-image: linear-gradient(to bottom right, #ef0488, #8624c2); color:white;">Tambah poli</button>
                    </div>
                </form>
