                ...
                <div class="border-black/12.5 shadow-soft-xl relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                  ...
                  <form action="{{ route('admin-storePasien') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="relative">
                          <input type="text" name="no_rm" class="w-full p-2 border rounded-md" style="width: calc(100% - 1rem); padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;" placeholder="Hanya pasien yang dapat mengambil nomor antrian!" readonly>
                      </div>
                    </div>                  
