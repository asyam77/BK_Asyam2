                    ...
                    <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                <h4 class="text-xl font-semibold mb-4">Halaman Dokter !</h4>
                                <h6 class="text-sm text-gray-500 mb-4">Disini dokter bisa melakukan Aktivitas berikut:</h6>
                            </div>
                        </div>
                        <!-- List of Actions -->
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                <ol class="list-decimal pl-6" style="list-style: decimal; color:black">
                                    <li class="mb-2">Melakukan Penerimaan pasien</li>
                                    <li class="mb-2">Melakukan Pemeriksaan Pasien</li>
                                    <li class="mb-2">Melakukan Penyuluhan terhadap pasien</li>
                                    <li class="mb-2">Melakukan Pelayanan Konsultasi</li>
                                </ol>
                            </div>
                        </div>
                    </div>
