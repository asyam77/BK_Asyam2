                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                <ol class="list-decimal pl-6" style="list-style: decimal; color:black">
                                    <li class="mb-2">Melakukan Pemesanan Antrian</li>
                                    <li class="mb-2">Melakukan Antrian</li>
                                    <li class="mb-2">Melakukan Pemeriksaan</li>
                                    <li class="mb-2">Melakukan Pembayaran</li>
                                </ol>
                            </div>
                        </div>
                    </div>
